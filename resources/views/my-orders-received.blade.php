    ...
    <div class="products-section my-orders container">
        <div class="sidebar">
            ...
            <ul>
              ...
              <li class="active"><a href="">To Receive</a> <font style="color: red;">({{ OrdersController::countOrders(5) }})</font></li>
        ...
        <div class="my-profile">
            <div class="products-header">
                <h1 class="stylish-heading">My Orders to receive</h1>
            </div>
                    ...
                    <div class="order-header">
                        ...
                        <div>
                            <div class="order-header-items">
                                ...
                                <div>|</div>
                                <div><a href="{{ route('orders.change.status',['id' => str_replace("#","w",$order->order_no), 'action' => '7']) }}">Mark As received</a></div>
