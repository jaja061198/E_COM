    ...
    <div class="products-section my-orders container">
        <div class="sidebar">
            ...
            <ul>
              ...
              <li class="active"><a href="">Completed</a> <font style="color: red;">({{ OrdersController::countOrders(7) }})</font></li>
              <li><a href="{{ route('orders.cancel') }}">Cancelled Order</a> <font style="color: red;">({{ OrdersController::countOrders(1) }})</font></li>
            </ul>
        </div> <!-- end sidebar -->
        <div class="my-profile">
            <div class="products-header">
                <h1 class="stylish-heading">My Completed Orders</h1>
            </div>
                    ...
                    <div class="order-header">
                        ...
                        <div>
                            <div class="order-header-items">
                                ...
                                <div>|</div>
                                <div><b style="color:red;">COMPLETED</b></div>
