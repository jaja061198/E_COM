    ...
    <div class="products-section my-orders container">
        <div class="sidebar">
            ...
            <ul>
              ...
              <li ><a href="{{ route('orders.index') }}">My Orders</a> <font style="color: red;">({{ OrdersController::countOrders(0) }})</font></li>
              ...
              <li class="active"><a href="{{ route('payment.index') }}">Cancelled Order</a> <font style="color: red;">({{ OrdersController::countOrders(1) }})</font></li>
            </ul>
        </div> <!-- end sidebar -->
                    ...
                    <div class="order-header">
                        ...
                        <div>
                            <div class="order-header-items">
                                ...
                                <div>|</div>
                                <div><b style="color:red;">CANCELELD</b></div>
